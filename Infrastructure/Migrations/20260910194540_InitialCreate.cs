        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediaFileName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediaFileName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Citizens", x => x.NationalId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutPart1 = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    AboutPart2 = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    OfficeLocation = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    WhatsApp = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    FacebookLink = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    LocationURL = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Circle = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Appointment = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    BlobName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    MediaFileName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ContentType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    FileSizeBytes = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CitizenRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CitizenRequirements_Citizens_CitizenNationalId",
                        column: x => x.CitizenNationalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CitizenRequirementContents", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CitizenRequirementEmployees", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CitizenRequirementEmployees_CitizenRequirementId_EmployeeId",
                table: "CitizenRequirementEmployees",
                columns: new[] { "CitizenRequirementId", "EmployeeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CitizenRequirements_CreatedAt",
                table: "CitizenRequirements",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CitizenRequirements_Status",
                table: "CitizenRequirements",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeOrganizations_EmployeeId_OrganizationId",
